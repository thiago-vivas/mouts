...
public class SaleCreatedEventHandler : DomainEventHandlerBase<SaleCreatedEvent>
{
    public SaleCreatedEventHandler(ILogger<SaleCreatedEventHandler> logger, IEventStore eventStore)
        : base(logger, eventStore) { }
}

public class SaleModifiedEventHandler : DomainEventHandlerBase<SaleModifiedEvent>
{
    public SaleModifiedEventHandler(ILogger<SaleModifiedEventHandler> logger, IEventStore eventStore)
        : base(logger, eventStore) { }
}

public class SaleCancelledEventHandler : DomainEventHandlerBase<SaleCancelledEvent>
{
    public SaleCancelledEventHandler(ILogger<SaleCancelledEventHandler> logger, IEventStore eventStore)
        : base(logger, eventStore) { }
}

public class ItemCancelledEventHandler : DomainEventHandlerBase<ItemCancelledEvent>
{
    public ItemCancelledEventHandler(ILogger<ItemCancelledEventHandler> logger, IEventStore eventStore)
        : base(logger, eventStore) { }
}
