...
public class SaleConfiguration : IEntityTypeConfiguration<Sale>
{
    public void Configure(EntityTypeBuilder<Sale> builder)
    {
        ...
        // Store/read SaleDate as UTC. PostgreSQL maps DateTime to timestamptz, which
        // Npgsql only accepts as UTC — normalize so a client date without an explicit
        // offset (Kind=Unspecified) doesn't fail the insert.
